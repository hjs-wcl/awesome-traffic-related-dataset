|数据集名称|数据集链接|数据集应用场景|数据集大小或图片数量|和交通相关的标签类型|能否直接下载|数据类型
|:-----|:---|:-----|:---------|:---------|:---------|:----------|
...
|BerkeleyDeepDrive|https://bdd-data.berkeley.edu/|车道（线）检测，道路物体（人、车、灯等）检测|1100小时的视频+100，000张图片|车道线|能|视频+图片|
...
|VERI-Wild|https://github.com/PKU-IMRE/VERI-Wild|车辆检测|30×24h视频+40，671图片|车辆车型|能|图片+视频|
...
|CULane Dataset|https://xingangpan.github.io/projects/CULane.html|车道线检测|133,235|车道线|能|图片|
...
| |https://medusa.fit.vutbr.cz/traffic/datasets/|车辆检测，车牌识别，车速检测|车辆：116k，车牌：2G|车辆定位，车牌识别|能|图片|
...
|HD1K Benchmark Suite|http://hci-benchmark.iwr.uni-heidelberg.de/|街道数据集|> 2560x1080的1000帧|道路，交通场景|能 发送申请邮件|图片| 
