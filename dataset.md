|dataset name|application scenarios for dataset|size of dataset and number of images |traffic related<br>label types|can or cannot dowmload directly|data type
|:-----|:-----|:---------|:---------|:---------|:----------|
